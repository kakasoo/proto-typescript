...
export namespace StringPrototype {
  export function slice<Container extends string, Start extends number, End extends number>(
    container: Container,
    start?: Start,
    end?: End,
   ...
   */
  export function indexOf<Container extends string, SearchString extends string = '', Position extends number = 0>(
    container: Container,
   ...
   */
  export function repeat<Container extends string, Counter extends number>(
    container: Container,
    counter: Counter,
   ...
   */
  export function startsWith<Container extends string, SearchString extends string, Position extends number>(
    container: Container,
   ...
   */
  export function endsWith<Container extends string, SearchString extends string, EndPosition extends number>(
    container: Container,
    searchString: SearchString,
   ...
   */
  export function substring<Conatiner extends string, Start extends number, End extends number | never = never>(
    container: Conatiner,
    start: Start,
    end?: End,
   ...
   */
  export function toLowerCase<Conatiner extends string>(container: Conatiner): Lowercase<Conatiner> {
   ...
   */
  export function toUpperCase<Conatiner extends string>(container: Conatiner): Uppercase<Conatiner> {
   ...
   */
  export function padStart<Conatiner extends string, TargetLength extends number, PadString extends string>(
    container: Conatiner,
   ...
   *        The default value for this parameter is " " (U+0020).
   */
  export function padEnd<Conatiner extends string, TargetLength extends number, PadString extends string>(
    container: Conatiner,
    targetLength: TargetLength,
    padString: PadString,
   ...
   */
  export function includes<Container extends string, SearchString extends string, Position extends number>(
    container: Container,
    searchString: SearchString,
    position?: Position,
   ...
   * @returns
   */
  export function trimStart<Conatiner extends string>(container: Conatiner): StringType.TrimStart<Conatiner> {
   ...
   * @returns
   */
  export function trimEnd<Conatiner extends string>(container: Conatiner): StringType.TrimEnd<Conatiner> {
   ...
   * @returns
   */
  export function trim<Conatiner extends string>(container: Conatiner): StringType.Trim<Conatiner> {
   ...
   */
  export function concat<Container extends string, Strings extends ReadonlyOrNot<string[]>>(
    container: Container,
    ...strings: Strings
   ...
   */
  export function at<Container extends string, Index extends number>(
    container: Container,
    index: Index,
